(function () {
  ...
  const TRUST_COPY = {
    ...
    'zh-CN': {
      note: `最后更新：${LAST_UPDATED}。本页属于 mmccode.com 上公开维护的 Morse Trainer 教程库。`,
      sectionTitle: '公开站点与编辑链接',
      sectionDesc: '教程内容独立于广告决策维护。如需查看勘误、支持、隐私或站点政策，请使用下方页面。',
      aboutTitle: '关于',
      aboutDesc: '了解这个项目提供什么、适合谁，以及网站如何维护。',
      editorialTitle: '编辑政策',
      editorialDesc: '查看教程如何审校、修正，并与广告决策保持分离。',
      privacyTitle: '隐私政策',
      privacyDesc: '了解账号、Cookie 以及基础设施相关数据如何处理。',
      glossaryTitle: '摩斯密码术语表',
      glossaryDesc: '用这个实用参考页学习术语、无线电简写和设备词汇。',
      sourcesTitle: '研究与来源',
      sourcesDesc: '查看历史页面、媒体示例与公开参考资料如何被整理和修正。',
      contactTitle: '联系',
      contactDesc: '使用公开支持页面提交勘误、隐私请求或直接求助。',
      footerLine: '结构化摩斯学习平台 - 教程、练习与公开支持页面',
      footerTutorials: '教程',
      footerStartHere: '从这里开始',
    ...
    ja: {
      note: `最終更新: ${LAST_UPDATED}。このページは mmccode.com で公開管理されている Morse Trainer チュートリアルライブラリの一部です。`,
      sectionTitle: '公開サイトと編集リンク',
      sectionDesc: 'チュートリアル内容は広告判断とは独立して管理されています。訂正、サポート、プライバシー、公開ポリシーの確認は下記ページをご利用ください。',
      aboutTitle: '概要',
      aboutDesc: 'このプロジェクトが提供する内容、対象ユーザー、サイトの運営方法を確認できます。',
      editorialTitle: '編集ポリシー',
      editorialDesc: 'チュートリアルがどのように確認・修正され、広告判断と分離されているかを説明します。',
      privacyTitle: 'プライバシーポリシー',
      privacyDesc: 'アカウント、Cookie、インフラ関連データの取り扱いを確認できます。',
      glossaryTitle: 'モールス信号用語集',
      glossaryDesc: '学習用語、無線略語、機材の語彙を確認できる実用的な参考ページです。',
      sourcesTitle: '調査と出典',
      sourcesDesc: '歴史ページ、メディア例、公開資料がどのように調査・修正されるかを確認できます。',
      contactTitle: 'お問い合わせ',
      contactDesc: '修正依頼、プライバシー申請、直接サポートは公開お問い合わせページをご利用ください。',
      footerLine: '構造化されたモールス学習プラットフォーム - チュートリアル、練習、公開サポートページ',
      footerTutorials: 'チュートリアル',
      footerStartHere: 'はじめに',
    ...
    ko: {
      note: `최종 업데이트: ${LAST_UPDATED}. 이 페이지는 mmccode.com에서 공개 관리하는 Morse Trainer 튜토리얼 라이브러리의 일부입니다.`,
      sectionTitle: '공개 사이트 및 편집 링크',
      sectionDesc: '튜토리얼 내용은 광고 결정과 별도로 관리됩니다. 수정, 지원, 개인정보, 공개 정책은 아래 페이지를 이용하세요.',
      aboutTitle: '소개',
      aboutDesc: '이 프로젝트가 제공하는 내용, 대상 사용자, 사이트 운영 방식을 확인할 수 있습니다.',
      editorialTitle: '편집 정책',
      editorialDesc: '튜토리얼이 어떻게 검토·수정되며 광고 결정과 분리되는지 설명합니다.',
      privacyTitle: '개인정보처리방침',
      privacyDesc: '계정, 쿠키, 인프라 관련 데이터가 어떻게 처리되는지 확인할 수 있습니다.',
      glossaryTitle: '모스 부호 용어집',
      glossaryDesc: '학습 용어, 무선 약어, 장비 용어를 확인할 수 있는 실용적인 참고 페이지입니다.',
      sourcesTitle: '조사와 출처',
      sourcesDesc: '역사 페이지, 미디어 예시, 공개 참고 자료가 어떻게 조사·수정되는지 확인할 수 있습니다.',
      contactTitle: '문의',
      contactDesc: '수정 요청, 개인정보 문의, 직접 지원은 공개 문의 페이지를 이용하세요.',
      footerLine: '체계적인 모스 학습 플랫폼 - 튜토리얼, 연습, 공개 지원 페이지',
      footerTutorials: '튜토리얼',
      footerStartHere: '시작하기',
      ...
      footerSources: '조사와 출처',
      footerHelp: '도움말 센터',
      footerFaq: '자주 묻는 질문',
      footerContact: '문의'
    },
    es: {
      note: `Última actualización: ${LAST_UPDATED}. Esta página forma parte de la biblioteca pública de tutoriales de Morse Trainer mantenida en mmccode.com.`,
      ...
      sourcesTitle: 'Investigación y fuentes',
      sourcesDesc: 'Consulta cómo se investigan y corrigen las páginas históricas, los ejemplos de medios y las referencias públicas.',
      ...
      footerSources: 'Investigación y fuentes',
