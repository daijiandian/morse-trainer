...
test('tutorial renderer trust copy stays readable across supported languages', () => {
  ...
  assert.match(source, /最后更新：2026 年 7 月 20 日 · 本页属于 mmccode\.com 公开维护的 Morse Trainer 教程内容体系。/);
  assert.match(source, /教程内容独立于广告决策进行维护。/);

  assert.match(source, /最終更新: 2026年7月20日 · このページは mmccode\.com で公開運用されている Morse Trainer のチュートリアル体系の一部です。/);
  ...
  assert.match(source, /최종 업데이트: 2026년 7월 20일 · 이 페이지는 mmccode\.com 에서 공개 운영 중인 Morse Trainer 튜토리얼 모음의 일부입니다\./);
  ...
  assert.match(source, /Última actualización: 20 de julio de 2026 · Esta página forma parte de la biblioteca pública de tutoriales de Morse Trainer mantenida en mmccode\.com\./);
